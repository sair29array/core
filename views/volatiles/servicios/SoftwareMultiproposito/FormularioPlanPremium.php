...
<?php 
 ...
 <?php 
 	if (isset($_POST["continuar_contrato"])) 
 	{
 		...
 		$sair->ActualizarDatosParaSolicitudDelServiciorSoftwareMultPlanMoviles($id_user,$nombres,$apellidos,$cedula,$celular,$ubicacion,"software_multiproposito","plan-premium");
 	}
  }else{

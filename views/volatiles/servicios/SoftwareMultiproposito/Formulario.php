<?php 
	// esto viene del index y de la DB
 	...
 	$servicio = "Plan App para escritorio - Software Multipropósito";
                ...
                <div class="card-body">
                    <!-- Material form register -->
                        ...
                        <!--div class="md-form">
                            ...
                            //}else{$ActualizarCedula = 1;} ?> required="required" name="cedula" value="<?php// echo $cedula; ?>"   type="hidden" id="materialFormCardNameEx"  class="form-control">
 ...
 <?php 
 	if (isset($_POST["continuar_contrato"])) 
 	{
 		...
 		$sair->ActualizarDatosParaSolicitudDelServiciorSoftwareMultPlanEscritorio($id_user,$nombres,$apellidos,$cedula,$celular,$ubicacion,"software_multiproposito","plan-básico");
 	}
  }else{
  	include("FormularioRegEmprpesa.php");
  }
  ?>
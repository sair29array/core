<?php if (!isset($_GET['solicitud-enviada'])) {
 ...
 <?php 
 	if (isset($_POST["reg_empresa"])) {
        ...
        $servicio = "mantenimiento_soporte_tecnico";
        ...
        ///////////////////////
 		...
 		$sair->registrar_solicitud_contrato($id_user,"mantenimiento_soporte_tecnico",$id_plan,$facturacion_empresa);

 		?> <script type="text/javascript">window.location="./?servicios=MantSoporteTécnico&reg_empresa&solicitud-enviada"</script> <?php 

...
if (isset($_GET['Reg-empresa'])) {
    ...
    if ($datos_user == 0 ) {
        ?><script type="text/javascript">window.location="./?servicios=Diseño_De_Paginas_web&solicitud=plan-básico";</script><?php 
		...
		?>
			<div class="row justify-content-center text-center margen-superior">
                <div class="col-12 margen-superior wow zoomIn" data-wow-delay="0.4s">
                    <h3 class="mt-5 mb-0">
                        <span><strong style="color: #1195ac;">Plan Básico</strong> Diseño & desarrollo de páginas web</span>
                    </h3>
    ...
    <form action="" method="POST">
		<div class="row justify-content-center text-center">
            ...
            <?php  // lo que quiero con esto es cambiar el boton o el nombre del boton para seguir con el contrato del servicio -- Diseño de paginas web - plan básico
                if (!isset($_GET["Reg-empresa"])) {
                    ?>
                    <div class="col-12 col-md-2  align-self-end flex-end margen-superior wow zoomIn" data-wow-delay="0.4s">
                    ...
                    ?>
                     <div class="col-12 col-md-2 align-self-end flex-end margen-superior " >
                    <h3 class="mt-5 mb-0"></h3>
                    ...
                    <?php 
                        ...
                        ?>
                    <div class="col-12 col-md-3 align-self flex-end margen-superior wow zoomIn" data-wow-delay="0.4s">
                    <h3 class="mt-5 mb-0"></h3>

...
<?php if (!isset($_GET['solicitud-enviada'])) {
 ...
 <div class="container barra-x-hidden">
    	<div class="row">
    		...
    		<div class="col-12 col-md-6 mt-3 mb-5 wow fadeInLeft margen-superior" data-wow-delay="0.4s">
	    		<!-- tarjeta-->
            <div class="card" >
 	...
 	if (isset($_POST["continuar_contrato2"])) {
       ...
       // $fecha = date("d")." de ". date("m"). " de ". date("y"); 
        ...
        ///////////////////////
 		...
 		?> <script type="text/javascript">window.location="./?servicios=Diseño_De_Paginas_web&solicitud=plan-premium&Reg-empresa&solicitud-enviada"</script> <?php 
 	}

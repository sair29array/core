...
if (isset($_GET['Reg-empresa'])) {
    ...
    if ($datos_user == 0 ) {
        ?><script type="text/javascript">window.location="../[array]/?servicios=Diseño_De_Paginas_web&solicitud=plan-premium";</script><?php 
	...
	if (!isset($_SESSION["user_log"])) {
		...
		?>
			<div class="row justify-content-center text-center">
                <div class="col-12">
                    <h3 class="mt-5 mb-0">
                        <span><strong style="color: #1195ac;" >Plan Premium</strong> Diseño & desarrollo de páginas web</span>
                    </h3>
                    ...
                    <a href="../[array]/?:=iniciar-sesion&SolicitudDeServicio=Diseño_De_Paginas_web&solicitud=plan-premium">
                        <button type="button" class="btn boton-c btn-lg mb-5">Iniciar sesión </button>
					</a>
					<a href="../[array]/?:=crear-cuenta&SolicitudDeServicio=Diseño_De_Paginas_web&solicitud=plan-premium">
    ...
    <form action="" method="POST">
                     ...
                     if (!isset($_GET["Reg-empresa"])) { // si no ha pasado el pprimer formulario de registro de datos faltantes del user
                        ...
                        if (!isset($_GET['solicitud-enviada'])) {
                            if ($user_['nit_empresa'] !=="" AND $user_['empresa']!== "") { // si no hay una emprpesa asociada al usuario...
                                 ?> 
                                 <p class="banner-txt">¿Deseas que la factura se realice a nombre de tu empresa <strong><?php echo $user_['empresa']; ?></strong> ?</p>
                            <?php 
                            }else{
                                 ?> 
		...
		include("FormularioPlanPremium.php");
	}
 ?>

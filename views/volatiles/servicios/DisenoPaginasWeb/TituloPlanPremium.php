...
if (isset($_GET['Reg-empresa'])) {
    ...
    if ($datos_user == 0 ) {
        ?><script type="text/javascript">window.location="./?servicios=Diseño_De_Paginas_web&solicitud=plan-premium";</script><?php 
		...
		?>
			<div class="row justify-content-center text-center">
                <div class="col-12">
                    ...
                    <a href="./?:=iniciar-sesion&SolicitudDeServicio=Diseño_De_Paginas_web&solicitud=plan-premium">
                        <button type="button" class="btn boton-c btn-lg mb-5">Iniciar sesión </button>
					</a>
					<a href="./?:=crear-cuenta&SolicitudDeServicio=Diseño_De_Paginas_web&solicitud=plan-premium">

...
<?php 
 ...
 <?php 
 	if (isset($_POST["continuar_contrato"])) 
 	{
 		...
 		$sair->ActualizarDatosParaSolicitudDelServicioDiseñoWebPlanPremium($id_user,$nombres,$apellidos,$cedula,$celular,$ubicacion,"Diseño_De_Paginas_web","plan-premium");
 	}
  }else{

...
<?php 
 ...
 <?php 
 	if (isset($_POST["continuar_contrato"])) 
 	{
 		...
 		$sair->ActualizarDatosParaSolicitudDelServicioradio_online_streaming_hd_plan_medium($id_user,$nombres,$apellidos,$cedula,$celular,$ubicacion,"Diseño_De_Paginas_web","plan-medium");
 	}
  }else{

<?php 
 ...
 <?php 
 	if (isset($_POST["continuar_contrato"])) 
 	{
 		...
 		$sair->ActualizarDatosParaSolicitudDelServicioradio_online_streaming_hd($id_user,$nombres,$apellidos,$cedula,$celular,$ubicacion,"radio_online_streaming_hd","plan-básico");
 	}
  }else{

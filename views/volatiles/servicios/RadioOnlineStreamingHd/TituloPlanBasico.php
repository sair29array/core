...
if (isset($_GET['Reg-empresa'])) {
    ...
    if ($datos_user == 0 ) {
        ?><script type="text/javascript">window.location="./?servicios=radio_online_streaming_hd&solicitud=plan-básico";</script><?php 
	...
	if (!isset($_SESSION["user_log"])) {
		...
		?>
			<div class="row justify-content-center text-center margen-superior barra-x-hidden">
                <div class="col-12 margen-superior wow zoomIn" data-wow-delay="0.4s">
                    <h3 class="mt-5 mb-0">
                        <span><strong class="blue-text" >Plan Básico</strong> Radio Online Streaming HD</span>
                    </h3>
    ...
    <form action="" method="POST">
		<div class="row justify-content-center text-center">
            ...
            <?php  // lo que quiero con esto es cambiar el boton o el nombre del boton para seguir con el contrato del servicio -- Diseño de paginas web - plan básico
                if (!isset($_GET["Reg-empresa"])) {
                    ?>
                    <div class="col-12 col-md-3  align-items-end margen-superior wow zoomIn" data-wow-delay="0.4s">
                    ...
                    ?>
                     <div class="col-12 col-md-3 align-items-end margen-superior">
                    <h3 class="mt-5 mb-0"></h3>

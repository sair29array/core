...
if (isset($_GET['Reg-empresa'])) {
    ...
    if ($datos_user == 0 ) {
        ?><script type="text/javascript">window.location="../[array]/?servicios=radio_online_streaming_hd&solicitud=plan-premium";</script><?php 
	...
	if (!isset($_SESSION["user_log"])) {
		...
		?>
			<div class="row justify-content-center text-center">
                <div class="col-12">
                    <h3 class="mt-5 mb-0">
                        <span><strong style="color: #1195ac;" >Plan Premium</strong> Radio Online Streaming HD</span>
                    </h3>

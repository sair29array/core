...
<br>
<!--Carousel Wrapper-->
<div id="carousel-example-2" class=" mt-5 carousel slide carousel-fade" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="carousel-item active">
            <div class="view">
                ...
                <img class="d-block w-100" src="img/mision.jpg" alt="First slide">

                <div class="mask rgba-black-light"></div>
            </div>
            <div class="carousel-caption">
                <a class="btn boton-c btn-lg" href="#>"><i class="fa fa-caret-down"></i></a>
            </div>
        ...
        <div class="carousel-item " role="listbox">
           ...
           <div class="carousel-caption wow fadeInUp" data-wow-delay="0.3s">
                <a class="btn boton-c btn-lg " href="#>"><i class="fa fa-caret-down" ></i></a>
            </div>
        </div>
...
<div id=">"></div>
    ...
    <section  class="team-about mt-5">
        <div  class="container">
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-7 mt-2 text-justify wow fadeInUp" data-wow-delay="0.3s">
                    <h1 class="h1-responsive mb-3 mt-5 text-center">Somos expertos en TIC</h1>
                    ...
                    <a href="#>>"><button type="button" class="btn boton-c btn-lg mb-5">Nuestro Equipo
                            <i class="fa fa-angle-down"></i></button></a>
                </div>
                <div  class="col-5 mt-5 d-none d-sm-none d-md-none d-lg-block d-xl-block align-self-center wow zoomIn" data-wow-delay="0.5s">
    ...
    <section class="team mt-5 " >
        <div class="container " >
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-sm-6 col-md-4 wow zoomIn mt-4" data-wow-delay="0.6s">
                    <div class="text-center">
